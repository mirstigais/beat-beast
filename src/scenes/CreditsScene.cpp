...
const bn::array<bn::string_view, 256> textItems = {
    "|Magical tragedy aligned|",
    "",
    "Directed by |Sewerbean|",
    "",
    "",
    "Music by |Sewerbean|, |Hug Zemitis|,",
    "|Asnate Lukasevica|, |Patriks Palsans|",
    "and |Dzulians Lapsa|",
    "",
    "Mix and master by,",
    "|Dzulians Lapsa|",
    "and |Hug Zemitis|",
    "",
    "Video editing by |Somsner|,",
    "|Sewerbean|, |ezis|",
    "",
    "Digital art by |Kleo|",
    "",
    "Physical production by |Mirstigais|,",
    "|Kleo|, |Maris|",
    "",
    "3D art and animations by",
    "|Ance Dalmane|",
    "",
    "Based on work from |Afska|",
    "(github.com/afska)",
    "",
    "Coding by |AZ| and |Mirstigais|",
    "",
    "External help by |many friends|,",
    "",
    "fans and kind strangers",
    "",
    "",
    "Thank you all!!",
    "",
